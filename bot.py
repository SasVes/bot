...
EQUIPMENT = {
    ...
    "Генератор, коммутация и тд.": {
        "Генератор 8кв": [1, 7500], "Генератор 2кв": [1, 3000], "Кабло 10м по 5шт": [2, 750], "Кабло 10м по 1шт": [5, 150], "Страховка 50см по 5шт": [2, 100], "V-mount": [2, 360], "Дым машина": [1, 1000], "Фал 30м": [2, 100], "Фал 20м": [2, 100], "Apple box 20/10": [2, 30], "Бабкина сумка": [1, 1]
    },
