...
EQUIPMENT = {
    "Приборы": {
        "600c": [1, 4000], "600x": [2, 3000], "300x": [2, 2100], "60x": [3, 900], "F22c": [3, 2100],
         "INFINIBAR 12": [3, 1050], "INFINIBAR 6": [1, 810],
         "MC Pro": [2, 600], "INFINIMAT 4": [1, 3000], "Dedolight": [1, 300], "600 дешевая опция": [3, 2300]
    },
    "Софтбоксы, насадки": {
        "соты INFINIBAR 12": [2, 390], "софтбокс INFINIBAR 12": [2, 600], "Lightdome 150": [1, 750], "Lightdome 90": [1, 600], "Lantern 90": [1, 600], "Softbox 60x": [2, 300]
    },
    "Плоскость": {
        "Фрост рама": [4, 200]
    },
    "Генератор, коммутация и тд.": {
        "Генератор 8кв": [1, 7500], "Генератор 2кв": [1, 3000], "Кабло 10м": [10, 100], "Страховка 50см": [10, 30], "V-mount": [3, 360], "Дым машина": [1, 1000], "Бабкина сумка": [1, 90]
    },
