...
EQUIPMENT = {
    "Приборы": {
        "1200x": [1, 6000], "600c": [1, 4000], "600x": [2, 3000], "300x": [2, 2100], "60x": [3, 900], "F22c": [3, 2100],
         ...
         "MC Pro": [2, 600], "Pipe 4": [1, 3500], "Pipe 42": [1, 5500], "INFINIMAT 4": [1, 3000], "B7c bulb": [1, 250], "Dedolight": [1, 300], "600 х/с за 2100": [3, 2100]
    },
    "Софтбоксы, насадки": {
        "соты INFINIBAR 12": [2, 390], "софтбокс INFINIBAR 12": [2, 600], "соты INFINIBAR 6": [1, 270], "софтбокс INFINIBAR 6": [1, 450], "Lightdome 150": [1, 750], "Lightdome 90": [2, 600], "Lantern 90": [1, 600], "Fresnel 2x + шторки": [1, 300], "Spotlight 26/19": [1, 900], "Lantern F22": [1, 390], "Софт для МС": [1, 150], "Рефлекторы 1200": [1,810], "Softbox 60x": [2, 300]
    },
    "Текстиль и тд.": {
        "UB 8x8": [1, 250], "S/B 8x8": [1, 250], "Отражатель": [1, 100]
    },
    "Генератор, коммутация и тд.": {
        "Генератор 8кв": [1, 7500], "Генератор 2кв": [1, 3000], "Кабло 10м по 5шт": [2, 750], "Кабло 10м по 1шт": [5, 150], "Страховка 50см по 5шт": [2, 100], "V-mount": [2, 360], "Дым машина": [1, 1000], "Фал 30м": [2, 150], "Фал 20м": [2, 100], "Apple box 20/10": [2, 30], "Бабкина сумка": [1, 1]
    },
