...
EQUIPMENT = {
    ...
    "Железо, Grip": {
    "C-stand 40": [1, 300], "A100": [1, 500], "Штатив карандаш": [3, 100], "Джуниор Бум": [1, 500], "Мачелини": [1, 60], "Супер клэмп": [1, 60], "Фал 30м": [2, 100], "Фал 20м": [2, 100], "Apple box 20/10": [2, 30], "Страховка 50см по 5шт": [2, 100], "Бабкина сумка": [1, 1]
    },
