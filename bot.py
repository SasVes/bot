...
EQUIPMENT = {
    ...
    "Софтбоксы, насадки": {
        "соты INFINIBAR 12": [2, 390], "софтбокс INFINIBAR 12": [2, 600], "Lightdome 150": [1, 750], "Lightdome 90": [1, 600], "Lantern 90": [1, 600], "Fresnel 2x + шторки": [1, 300], "Lantern F22": [1, 390], "Рефлекторы 1200": [1,810], "Softbox 60x": [2, 300]
    },
    "Плоскость": {
