...
EQUIPMENT = {
    "Приборы": {
        "1200x": [1, 6000], "700x": [2, 3500], "600c": [1, 3500], "400x": [2, 2500], "300x": [2, 2100], "80c": [2, 1200], "60x": [3, 900], "F22c": [3, 2100],
    ...
    "Софтбоксы, насадки": {
        "Lightdome 150": [1, 750], "Lightdome 90": [2, 600], "Lantern 90": [1, 600], "Fresnel F10 + шторки": [1, 600], "Fresnel 2x": [2, 300], "Spotlight 26/19": [1, 900], "соты INFINIBAR 12": [2, 300], "софтбокс INFINIBAR 12": [2, 600], "соты INFINIBAR 6": [1, 210], "софтбокс INFINIBAR 6": [1, 450], "Lantern F22": [1, 390], "Софт для МС": [1, 150], "Рефлекторы 1200": [1,810], "Softbox 60x": [3, 300]
    },
    "Железо, Текстиль, Плоскота.": {
       "Штатив карандаш": [3, 100], "Фрост рама 40": [2, 100], "UB 8x8": [1, 250], "S/B 8x8": [1, 250], "Автопол/Тбон 8": [1, 150], "Отражатель": [1, 100]
    },
    "Генератор, Коммутация, Grip.": {
        "Кабло 10м по 5шт": [2, 750], "Кабло 10м по 1шт": [5, 150], "5ти яйцевый": [3, 90], "Страховка 50см по 5шт": [2, 100], "V-mount": [3, 360], "Дым машина": [1, 1000], "Фал 30м": [2, 100], "Фал 20м": [2, 100], "Генератор 8кв": [1, 7500], "Генератор 2кв": [1, 3000], "Apple box 20/10": [2, 30], "Бабкина сумка": [1, 1]
    },
