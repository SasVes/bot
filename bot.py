...
EQUIPMENT = {
    "Приборы": {
        "600c": [1, 4000], "600x": [2, 3000], "300x": [2, 2100], "60x": [3, 900], "F22c": [3, 2100],
         "INFINIBAR 12": [3, 1050], "INFINIBAR 6": [2, 810],
         "MC Pro": [2, 600], "INFINIMAT 4": [1, 3000]
    },
    "Софтбоксы, насадки": {
        "соты INFINIBAR 12": [2, 390], "софтбокс INFINIBAR 12": [1, 600], "Lightdome 150": [1, 750], "Lightdome 90": [1, 600], "Lantern 90": [1, 600]
    },
    "Плоскость": {
        "Фрост рама": [4, 200], "Флоппарь": [2, 200], "Флаг 24х36": [2, 150]
    },
    "Генератор, коммутация и тд.": {
        "Генератор 6.5кв": [1, 6900], "Кабло 10м": [10, 100], "V-mount": [3, 360], "Дым машина": [1, 1000], "Бабкина сумка": [1, 90]
    },
