...
EQUIPMENT = {
    "Приборы": {
        "1200x": [1, 6000], "600c": [1, 4000], "600x": [2, 3000], "400x": [2, 2500], "300x": [2, 2100], "80c": [2, 1200], "60x": [3, 900], "F22c": [3, 2100],
         "INFINIBAR 12": [3, 1050], "INFINIBAR 6": [1, 810],
         "MC Pro": [2, 600], "Pipe 4": [1, 3500], "Pipe 42": [1, 5500], "INFINIMAT 4": [1, 3000], "B7c bulb": [1, 250], "Dedolight": [1, 300], "600 х/с за 2100": [3, 2100], "80с за 900": [2, 900]
    },
    "Софтбоксы, насадки": {
        "Lightdome 150": [1, 750], "Lightdome 90": [2, 600], "Lantern 90": [1, 600], "Fresnel F10 + шторки": [1, 600], "Fresnel 2x + шторки": [1, 300], "Spotlight 26/19": [1, 900], "соты INFINIBAR 12": [2, 300], "софтбокс INFINIBAR 12": [2, 600], "соты INFINIBAR 6": [1, 210], "софтбокс INFINIBAR 6": [1, 450], "Lantern F22": [1, 390], "Софт для МС": [1, 150], "Рефлекторы 1200": [1,810], "Softbox 60x": [3, 300]
    },
