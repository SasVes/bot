...
EQUIPMENT = {
    "Приборы": {
        "1200x": [1, 6000], "600c": [1, 4000], "600x": [2, 3000], "300x": [2, 2100], "60x": [3, 900], "F22c": [3, 2100],
         ...
         "MC Pro": [2, 600], "Pipe 4": [1, 3000], "Pipe 42": [1, 5500], "INFINIMAT 4": [1, 3000], "Dedolight": [1, 300], "600 х/с за 2100": [3, 2100]
    },
    "Софтбоксы, насадки": {
        "соты INFINIBAR 12": [2, 390], "софтбокс INFINIBAR 12": [2, 600], "Lightdome 150": [1, 750], "Lightdome 90": [1, 600], "Lantern 90": [1, 600], "Fresnel 2x + шторки": [1, 300], "Spotlight 26/19": [1, 900], "Lantern F22": [1, 390], "Рефлекторы 1200": [1,810], "Softbox 60x": [2, 300]
    },
    "Плоскость": {
