...
EQUIPMENT = {
    ...
    "Генератор, коммутация и тд.": {
        "Генератор 8кв": [1, 7500], "Генератор 2кв": [1, 3000], "Кабло 10м по 5шт": [2, 750], "Кабло 10м по 1шт": [5, 150], "Страховка 50см": [10, 30], "V-mount": [3, 360], "Дым машина": [1, 1000], "Бабкина сумка": [1, 1]
    },
